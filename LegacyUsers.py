...
class User(object):
	...
	def toAccountLine(self):
		return ' '.join((self.casename, self.password, self.getAccess(), self.last_id, str(int(self.last_login*1000)), self.last_ip, str(int(self.register_date*1000)), self.country, self.id))
